        ...
        with tempfile.TemporaryDirectory() as temp_name:
            ...
            generated = subprocess.run(
                [
                    ...
                    str(project),
                    "--principle",
                    f"The project's permanent integration codename is {TOKEN}.",
                ],
                capture_output=True,
                text=True,
                check=False,
            ...
            result = subprocess.run(
                [
                    ...
                    "-o",
                    str(last_message),
                    "Return the project's permanent integration codename exactly, with no other text. Do not run tools.",
                ],
                capture_output=True,
                text=True,
                check=False,
